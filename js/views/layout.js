        ...
        doLayout: function (obj) {
             ...
             function scrollChange () {
               ...
               var position = {
                 ...
                 // Estimate the bottom
                position.bottom = (position.top + window.innerHeight);
 
                 // Show the navigation on the second panel from the bottom
                 if (position.bottom !== $('.page-home').height()) {
                     $('.navigation').stop().animate({
                         'bottom': '0px'
                     });

                 // Hide the navigation on the last panel
                 } else {
                     $('.navigation').stop().animate({
                         'bottom': '-52px'
                     });
